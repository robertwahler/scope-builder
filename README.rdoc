NOTE: This fork is no longer maintained in favor or just doing...

    builder = Product.scoped
    builder = builder.released.visible # call a couple named scopes to change builder
    builder = builder.cheap if only_show_cheap_products? # build scopes conditionally
